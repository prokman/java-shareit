          ...
          CREATE TABLE IF NOT EXISTS REQUESTS (
              ...
              PRIMARY KEY(id),
              CONSTRAINT requests_users_fk FOREIGN KEY (OWNER_ID) REFERENCES USERS(ID) ON DELETE CASCADE
            );
          ...
          CONSTRAINT items_request_fk FOREIGN KEY (REQUEST_ID) REFERENCES REQUESTS(ID) ON DELETE NO ACTION
          );
